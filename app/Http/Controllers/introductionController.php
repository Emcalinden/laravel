...
class introductionController extends Controller
{
    ...
    {
		$text = 'This website aims to provide you with a great knowledge of Recurrence Relations
		and how to prove the Closed-form expression by Mathematical Induction.';
